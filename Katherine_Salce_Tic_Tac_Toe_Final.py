...
Description: Play the game Tic_Tac_Toe by yourself with the help of your computer! 
Date: 12/2/2024
Bugs: None
References: Mr. Campbell and past code
'''
import random                                                                                           #importing random library

def printBox(box):                                                                                      #defining the function printbox, taking in the parameter box
    for i in range (len(box)):                                                                          #building coordinate system
        for j in range (len(box[i])):                                                                   #building coordinate system
            print(box[i][j], end=' ')                                                                   #print box as a string
        print("")                                                                                       #printing string (in the form of grid)
...
def checkSpot(box,current_player):                                                                      #defining the function checkSpot taking in parameters box and current_player
    ...
    while True:                                                                                         #prompting loop, usign conditional while the statement is true
        printBox(box)                                                                                   #calling function printBox taking in parameter box
        ...
        if user_player_spot_choice == "1" and box[0][0] == 1:                                           #if current_player choses the number 1 check to see if position is equal to 1
           ...
           break                                                                                        #ending code
            ...
            continue                                                                                    #going back to the top of the while true fucntion (looping)
    ...
    while game_loop:                                                                                    #while completing the function game_loop
        ...
        while count < 9:                                                                                #while the number of position entries (or turns) is less than 9
            if turn == "O":                                                                             #if turn is equal to player O
                ...
                count += 1                                                                              #add +1 to count after each turn
                turn = "X"                                                                              #player X
                status = CheckWinner(current_player, box)                                               #checking for winner using parameters current_player and box to assess status of game                                                                             #second turn equal to player X
                current_player = user_player_assignment                                                 #setting current_player to user_player_assignment 
               
                if status == "stop":                                                                    #if game status is stopped
                    print("Game Over! Final Board:")                                                    #print message
                    printBox(box)                                                                       #printing box
                    break                                                                               #ending code                                                                   #print messege
            ...
            if count == 9:                                                                              #if count equals 9
                                                                                          
                print("You Tied!")                                                                      #print message
                exit()                                                                                  #ending code

if __name__ == "__main__":                                                                              #when program starts call the main
