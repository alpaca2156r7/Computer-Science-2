...
fhand = open('cleaned_trump_speech_transcript.txt')                                                                          #making an fhand variable that opens a text file                                                                                  
counts = dict()                                                                                                              #counting each time word in dictionary is used

bad_words = ['going','every','these', 'can', 'as', 'what','out','was','or', 'from', 'has', 'with', 'been', 'be', 'other', 'it', 'are', 'because', 'that', 'on', 'new', 'an', 'have', 'so', 'but', 'ever', 'than', 'this', 'were', 'and', 'its', 'in', 'is', 'a', 'to', 'the', 'at', 'of', 'for','who','not','now','by','am'] #variable bad words takes out words that are not useful to the narrative of the story
...
election_file = open ('Katherine_Salce_Election_Word_Count_Trump.csv', 'w')                                                 #making variable called election_file and setting it equal to open which allows file to access data from fiel and write into alternative file
